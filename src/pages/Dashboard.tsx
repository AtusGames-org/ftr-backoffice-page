    ...
    <div className="space-y-6">
      <section className="app-card p-6">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <StatCard
            title="Total Players"
            value={summary ? summary.totalPlayers.toLocaleString() : "--"}
            caption="All-time registered"
          />
          <StatCard
          ...
          <StatCard
            ...
            value={
              summary
                ? summary.avgPlayerTime !== null
                  ? `${summary.avgPlayerTime} min`
                  : "--"
                : "--"
            }
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <StatCard
          title="Worlds Online"
          value={
            summary ? `${summary.worldsOnline}/${summary.totalWorlds}` : "--"
          }
        ...
        <StatCard
          title="Zones Online"
          value={
            summary ? `${summary.onlineZones}/${summary.totalZones}` : "--"
          }
        ...
        <StatCard
          title="Gems Flow"
          value={
            summary && summary.gemsFlow !== null
              ? `${summary.gemsFlow.toFixed(2)}`
              : "--"
          }
      ...
      <section className="app-card p-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          ...
          <StatCard
            ...
            value={
              summary ? summary.userCreatedCosmetics.toLocaleString() : "--"
            }
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        <StatCard
          ...
          value={
            summary ? summary.totalGemsInCirculation.toLocaleString() : "--"
          }
